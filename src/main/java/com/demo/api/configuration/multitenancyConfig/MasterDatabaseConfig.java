package com.demo.api.configuration.multitenancyConfig;
...
@EnableJpaRepositories(basePackages = { "com.demo.api.configuration.multitenancyConfig.model",
        "com.demo.api.configuration.multitenancyConfig.repository" }, entityManagerFactoryRef = "masterEntityManagerFactory", transactionManagerRef = "masterTransactionManager")
